...
from common.system import get_premiere_projects_in_folder, get_videos_in_folder, resolve_relative_path, rebuild_path, is_file_available, sort_paths, \
...
def summarize_folders(engine:Engine, one_drive_folder:Path, review_folder:Path, review_string:str,
    ...
    for year_folder in sort_paths(year_folders):
        ...
        if len(media_files):
            files_df = fetch_files(engine, project_year)
