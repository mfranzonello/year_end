...
st.set_page_config(page_title='Family YIR Stats',
                   layout='wide')
years = get_project_years(engine).sort_values('project_year')
...
match quantity:
    ...
    case 'rating_count':
        ...
        submission_string = f'**{round(rated_percent*100, 1)}%** rated with **{round(average_rating, 2)} :star:** average per video'
