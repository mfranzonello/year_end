...
def main() -> None:
    ...
    try:
        managed_events = list_managed_events(calendar_id, force_login=args.login)
    ...
    print(f"Connected to the configured calendar. Found {len(managed_events)} project-managed event(s).")
